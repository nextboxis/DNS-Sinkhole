...
class CaptureManager:
    ...
    def _build_summary_locked(self) -> Dict[str, Any]:
        ...
        return {
            ...
            # Enhanced analytics for frontend charts
            "recordTypeBreakdown": dict(record_types),
            "topDomains": [{"domain": d, "count": c} for d, c in domains.most_common(8)],
            "topSourceIps": [{"ip": ip, "count": c} for ip, c in source_ips.most_common(5)],
            "rcodeBreakdown": dict(rcodes),
            "threatBreakdown": dict(threat_levels),
        }
